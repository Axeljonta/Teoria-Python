...
#Haciendo una busqueda simple una vez que encuentra un hola deja de buscar
#flags=re.IGNORECASE si queremos ignorar mayusculas o minusculas
resultado = re.search("Esta",texto,flags=re.IGNORECASE) 

#Haciendo una busqueda simple busca todos los hola 
